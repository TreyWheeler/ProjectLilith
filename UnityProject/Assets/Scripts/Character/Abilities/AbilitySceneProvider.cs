...
public static class AbilitySceneProvider
{
    ...
    private static void CreateHealGroup()
    {
        ...
        AdjustStatForManySceneAction health = new AdjustStatForManySceneAction();
        health.Adjustment = "{Caster}<Character>.Stats[LilithStats.Intelligence].CurrentValue * 3";
        health.StatToAdjust = LilithStats.Health;
        health.TeamToAdjust = "{Target}<Character>.MyTeam";
        heal.Add(health);
        ...
        loadedScenes.Add(LilithAbilities.HealGroup, heal);
    }
